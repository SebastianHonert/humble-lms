...
$labels = array(
  'name'                  => _x( 'Certificates', 'Post Type General Name', 'humble_lms' ),
  'singular_name'         => _x( 'Certificate', 'Post Type Singular Name', 'humble_lms' ),
  'menu_name'             => __( 'Certificates', 'humble_lms' ),
  'name_admin_bar'        => __( 'Certificates', 'humble_lms' ),
  'archives'              => __( 'Certificate Archives', 'humble_lms' ),
  'attributes'            => __( 'Certificate Attributes', 'humble_lms' ),
  'parent_item_colon'     => __( 'Parent Certificate:', 'humble_lms' ),
  'all_items'             => __( 'All Certificates', 'humble_lms' ),
  'add_new_item'          => __( 'Add New Certificate', 'humble_lms' ),
  'add_new'               => __( 'Add New', 'humble_lms' ),
  'new_item'              => __( 'New Certificate', 'humble_lms' ),
  'edit_item'             => __( 'Edit Certificate', 'humble_lms' ),
  'update_item'           => __( 'Update Certificate', 'humble_lms' ),
  'view_item'             => __( 'View Certificates', 'humble_lms' ),
  'view_items'            => __( 'View Certificates', 'humble_lms' ),
  'search_items'          => __( 'Search Certificate', 'humble_lms' ),
  ...
  'insert_into_item'      => __( 'Insert into certificate', 'humble_lms' ),
  'uploaded_to_this_item' => __( 'Uploaded to this certificate', 'humble_lms' ),
  'items_list'            => __( 'Certificates list', 'humble_lms' ),
  'items_list_navigation' => __( 'Certificates list navigation', 'humble_lms' ),
  'filter_items_list'     => __( 'Filter certificates list', 'humble_lms' ),
);

$rewrite = array(
  'slug'                  => __('certificates', 'humble-lms'),
  'with_front'            => true,
  'pages'                 => true,
  'feeds'                 => true,
);
...
$args = array(
  'label'                 => __( 'Certificate', 'humble_lms' ),
  'description'           => __( 'Certificate', 'humble_lms' ),
  'labels'                => $labels,

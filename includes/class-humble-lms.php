...
class Humble_LMS {
  ...
  private function define_admin_hooks() {
    ...
    if( is_admin() ) {
      $this->loader->add_action( 'ajax_query_attachments_args', $plugin_admin, 'restrict_user_attachments' );
    }
    ...
    // Multisite
    $this->loader->add_action( 'wpmu_new_blog', $plugin_admin, 'new_blog', 10, 6 );
